...
class DefaultTorrentFiles implements TorrentFiles {
    ...
    private DefaultTorrentFiles(URL metainfoUrl, Map<String, byte[]> files) {
    ...
    public static class Builder {
        ...
        public TorrentFiles build() {
            ...
            return new DefaultTorrentFiles(metainfoUrl, files);
        }
    }
}
