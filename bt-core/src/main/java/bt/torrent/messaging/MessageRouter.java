...
class MessageRouter {
    ...
    MessageRouter(Collection<Object> messagingAgents) {
        ...
        messagingAgents.forEach(this::addMessagingAgent);
    }

    final void addMessagingAgent(Object agent) {
    ...
    <T extends Message> void consume(T message, MessageContext context) {
        mergeChanges();
